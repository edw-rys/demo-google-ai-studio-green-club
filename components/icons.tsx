...
export const QrCodeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 6.75h.75v.75h-.75v-.75ZM6.75 16.5h.75v.75h-.75v-.75ZM16.5 6.75h.75v.75h-.75v-.75ZM13.5 13.5v.75h.75v.75h.75v.75h.75V18h.75v-1.5h.75v-1.5h.75v-1.5h.75v-.75h.75v-.75H13.5Z" />
    </svg>
);
...
export const ChevronDownIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" /></svg>
);
...
export const EyeSlashIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.572M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /><path strokeLinecap="round" strokeLinejoin="round" d="m2.747 2.747 18.506 18.506" /></svg>
);
...
export const RewardIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const UserIcon = ProfileIcon; // Alias for profile menu
...
export const GiftIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a8.25 8.25 0 0 1-16.5 0v-8.25a8.25 8.25 0 0 1 16.5 0Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v.75a3 3 0 0 0 3 3h3a3 3 0 0 0 3-3v-.75Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75a3 3 0 0 1 3-3h3a3 3 0 0 1 3 3v.75a3 3 0 0 1-3 3h-3a3 3 0 0 1-3-3v-.75Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75v-9m0 0-3 3m3-3 3 3" /></svg>
);
export const BenefitsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
);
export const LockIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 0 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" /></svg>
);
...
export const CogIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.95.541.057 1.008.523 1.058 1.115l.383 2.296c.287.05.568.125.84.218l2.252-.643a1.125 1.125 0 0 1 1.226.318l1.585 2.746a1.125 1.125 0 0 1-.215 1.353l-1.85 1.596c.02.16.03.32.03.481s-.01.321-.03.481l1.85 1.596a1.125 1.125 0 0 1 .216 1.353l-1.585 2.746a1.125 1.125 0 0 1-1.226.318l-2.252-.644a7.433 7.433 0 0 1-.84.218l-.383 2.296c-.05.592-.517 1.058-1.115 1.058-.592 0-1.065-.466-1.115-1.058l-.383-2.296a7.46 7.46 0 0 1-.84-.218l-2.252.644a1.125 1.125 0 0 1-1.226-.318L3.23 15.99a1.125 1.125 0 0 1 .215-1.353l1.85-1.596a.79.79 0 0 0-.03-.481c0-.161.01-.32.03-.481L3.445 10.3a1.125 1.125 0 0 1-.215-1.353L4.774 6.2a1.125 1.125 0 0 1 1.226-.318l2.252.643a7.447 7.447 0 0 1 .84-.218l.383-2.296Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
);
...
export const ChatBubbleLeftRightIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 0 1-1.59 0l-3.72-3.72a2.122 2.122 0 0 1-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097m0 0A5.25 5.25 0 0 0 6 12.75v4.286c0 .414.336.75.75.75h3v3.75a.75.75 0 0 0 1.5 0v-3.75h3a.75.75 0 0 0 .75-.75v-4.286a5.25 5.25 0 0 0-3.75-5.242Z" /></svg>
);
...
export const ArrowUpIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" /></svg>
);
