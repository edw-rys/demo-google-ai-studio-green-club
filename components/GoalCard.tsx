    ...
    return (
        <div className="px-4 mt-4">
            <div className="bg-white rounded-2xl shadow-sm p-4">
                <p className="text-sm font-medium text-gray-500">Tu objetivo rápido</p>
                <div className="flex items-center gap-4 mt-2">
                    <img src={goalReward.imageUrl} alt={goalReward.name} className="w-16 h-16 rounded-lg" />
                    <div className="flex-1">
                        <h3 className="text-lg font-bold text-[#263238]">{goalReward.name}</h3>
                 ...
                 <button className="w-full mt-4 bg-[#A5D6A7]/50 text-[#2E7D32] font-semibold py-2 rounded-lg hover:bg-[#A5D6A7]/80 transition-colors">
                    Ver catálogo
                </button>
            </div>
        </div>
    ...
    <div className="px-4 mt-4">
      <div className="bg-white rounded-2xl shadow-sm p-4">
        <div className="flex justify-between items-center">
          <p className="font-semibold text-[#263238]">Tu objetivo: <span className="text-[#2E7D32]">{goalReward.name}</span></p>
        ...
        <p className="text-xs text-gray-600 mt-1">Faltan <span className="font-bold">{pointsNeeded}</span> puntos</p>
      </div>
    </div>
  );
};
