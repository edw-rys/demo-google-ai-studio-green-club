...
const InputField = ({ label, id, value, type = 'text' }: { label: string, id: string, value: string, type?: string }) => (
    <div>
        ...
        <input 
            ...
            id={id} 
            defaultValue={value}
            className="w-full bg-white border border-gray-300 rounded-lg p-3 text-[#263238]" 
        />
    </div>
);
        ...
        <Screen title="Editar Perfil">
            <div className="text-center mb-6">
                <div className="relative inline-block">
                    <img src={user.avatarUrl} alt="Avatar" className="w-24 h-24 rounded-full border-4 border-white shadow-lg" />
            ...
            <form className="space-y-4">
                ...
                <div className="pt-4 flex gap-3">
                     <button type="button" className="w-full bg-gray-200 text-[#263238] font-semibold py-3 rounded-lg hover:bg-gray-300 transition-colors">
                        Cancelar
                    </button>
